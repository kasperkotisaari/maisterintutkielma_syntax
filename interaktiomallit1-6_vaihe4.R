...
plot(x, y2, type = "b", pch=5, frame = FALSE, lty= 3, lwd=1,
     ...
     main = "Interaktiomalli 3, miesvastaajat", xlim = c(0.8,3.2),ylim=c(0,0.1), xaxt="n")
...
legend("bottomright",inset=c(-0.21,0), xpd=TRUE, legend=paste("N = ", Nint3m))
...
legend("topright", inset=c(-0.23,0), xpd=TRUE, legend=c("Vaikeuksia tulla toimeen", "CI95% alempi", "CI95% ylempi"),
       col=c("#FF00FF", "#FD8210", "#FD8210"), lty = c(1,3,2), pch=1, cex=0.9)
